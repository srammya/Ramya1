...
public class CustomReport extends CustomReporterListener{
    ...
    protected PrintWriter createWriter(String outdir) throws IOException {
        ...
        return new PrintWriter(new BufferedWriter(new FileWriter(new File(
                outdir, "emailable-adidas-report" + now
                        + ".html"))));
    }
        ...
        for (ITestResult result : tests.getAllResults()) {
            ...
            if (hasParameters) {
                ...
                for (Object p : parameters) {
                    m_out.println(Utils.escapeHtml(Utils.toString(p, null)) + " | ");
                }
            }
    ...
    private void generateForResult(ITestResult ans, ITestNGMethod method,
        ...
        if (hasParameters) {
            ...
            for (Object p : parameters) {
                m_out.println("<td>" + Utils.escapeHtml(Utils.toString(p, null))
                        + "</td>");
            }
            m_out.println("</tr>");
        }
    ...
    public void generateSuiteSummaryReport(List<ISuite> suites) {
        ...
        for (ISuite suite : suites) {
            ...
            for (ISuiteResult r : tests.values()) {
                ...
                // NEW
              /*  summaryCell(overview.getStartDate(),true);
                m_out.println("</td>");
                summaryCell( DateFunctions.dateToDayAndTime(overview.getEndDate()),
                        true);
                m_out.println("</td>");*/
