...
public class VisaPaymentDetailsPage {
	...
	public VisaPaymentDetailsPage(WebDriver driver){ 
	    this.driver = driver; 
	...
	public void selectCardType(String ccType){
		try{
			...
			ReusableActions.selectedRadioButton(driver, creditCard, "Select the credit option");
			
			inAction.selectItemFromDropdown(driver,cardType,ccType,"Select the card type as Visa");
...
//		
		...
		inAction.selectItemFromDropdown(driver,cardType,ccType,"Select the card type as Visa");
		inAction.inputText(driver,cardNumber,ccNumber,"Enter Credit Card Number");
		inAction.selectValueFromDropdown(driver,cardExpiryMonth,ccExpiryMonth,"Select the card expiry month");
		inAction.selectItemFromDropdown(driver,cardExpiryYear,ccExpiryYear,"Select the card expiry Year");
		inAction.inputText(driver,cardId,cvv,"Enter Credit Card cvv");
		proceedPayment();
	...
	try{
		inAction.selectCheckbox(driver, chkSubscribe, "Check the Sucscribe check box");
		inAction.selectCheckbox(driver, chkTermsCondition, "Check the terms and condition");
