...
public class LoginCheckoutWithMasterCard extends GeneralActions{
	...
	MasterPaymentDetailsPage masterPaymentDetailsPage=new MasterPaymentDetailsPage(driver);
	...
	GeneralActions genAction = new GeneralActions();
	 ...
	 public void checkoutAsLoginCheckoutWithMasterCard(){
		 uniqloHomePage =new UniqloHomePage(driver);
	 ...
	 public void paymentDetailsLoginCheckoutWithMasterCard(String cType,String cNumber,String cExpiryMonth,String cExpiryYear,String cccvv){
		 ...
		 try{
				ReusableActions.waitForpageToLoad(driver);
				masterPaymentDetailsPage.selectPaymentDetails(cType,cNumber,cExpiryMonth,cExpiryYear,cccvv);
				Thread.sleep(10000);
