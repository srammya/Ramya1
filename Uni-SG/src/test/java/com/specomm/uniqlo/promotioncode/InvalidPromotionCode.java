package com.specomm.uniqlo.promotioncode;
...
import com.specomm.uniqlo.pagecomponents.PromotionCodePage;
...
static WebDriver driver;
	...
	PromotionCodePage promotionCodePage=new PromotionCodePage(driver);
	...
	GeneralActions genAction = new GeneralActions();
	 ...
	 @BeforeClass
	  public void setUp() throws IOException, InterruptedException {
		 driver = getDriver();
		  ...
		  promotionCodePage=PageFactory.initElements(driver, PromotionCodePage.class);
	 ...
	 @Test(priority = 3 ,dataProviderClass=PromotionCodePage.class,dataProvider="getData")
	 public void applyPromocheckoutAsGuestWithVisaCard(String promo){
		
			
		 try{
				
				
				promotionCodePage.applyInvalidPromo(promo);
	 ...
	 public void paymentDetailscheckoutAsGuestWithVisaCard(String cType,String cNumber,String cExpiryMonth,String cExpiryYear,String cccvv){
		 paymentDetailsPage=new VisaPaymentDetailsPage(driver);
			
		 try{
				
				paymentDetailsPage.selectCardType("Visa");
