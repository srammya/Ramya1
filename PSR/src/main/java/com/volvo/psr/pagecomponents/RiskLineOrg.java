...
public class RiskLineOrg extends CommonWrapperMethods  {

	protected WebDriver driver;
	static String directory;
	static String Severity,Issue,Corrective_Action,Variant,Sop,Flow,A,B,C,D,E,Responsible,Focus,Status,pdfData;

public RiskLineOrg(WebDriver driver){ 
    this.driver = driver; 
    PageFactory.initElements(driver, this);
 	}

public void riskLineRep(String unitId) {
...
public void riskLineRepDropDown(String unitId) {
...
public void riskLineMsr(String unitId) {
