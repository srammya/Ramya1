...
public class MsrLineOrg extends CommonWrapperMethods  {
	...
	public MsrLineOrg(WebDriver driver){ 
	    this.driver = driver; 
	    PageFactory.initElements(driver, this);
}
	
public void msrLineRep(String unitId, String milestoneAbrr, String milestoneLabel) {
...
public void validatePDFReport() {
	...
	if(pdfData.contains("The purpose at <PS> is to start the program and set prerequisites,\r\n" + 
