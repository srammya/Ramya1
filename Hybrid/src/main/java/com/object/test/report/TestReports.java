package com.object.test.report;
...
public class TestReports {
    ...
    public static void startTesting(String filename, String testStartTime, String env, String rel) {
        ...
        try {
            ...
            out.write("<html>\n");
            out.write("<HEAD>\n");
            out.write("<td width=150 align=left><FONT COLOR=#0A4984 FACE=Arial SIZE=2.75> <img src='logo.png' align=left></img></td>\n");
            

            out.write(" <TITLE>Leasing Automation Test Results by QA Team</TITLE>\n");
            out.write("</HEAD>\n");
            ...
            // out.write("<td width=150 align=right><FONT COLOR=#0A4984 FACE=Arial SIZE=2.75> <img src='lyris.png' align=right></img></td>\n");
            ...
            out.write("<tr>\n");
            out.write("<tr>\n");
            out.write("<h2 align=center><FONT COLOR=#0A4984 FACE=AriaL SIZE=6><b>Email Automation Test Results</b></h2>\n");
            ...
            out.write("<td width=150 align= left  bgcolor=#58ACFA><FONT COLOR=#0A4984 FACE= Arial  SIZE=2.75><b>Environment</b></td>\n");
            ...
            out.write("<td width=150 align= left ><FONT COLOR=black FACE= Arial  SIZE=2.75><b>ABC Team </b></td>\n");
            out.write("</tr>\n");
    ...
    public static void addTestCase(String testCaseName, String testCaseStartTime, String testCaseEndTime, String status) throws Exception {
        ...
        try {
            ...
            if (status.equalsIgnoreCase("Skipped") || status.equalsIgnoreCase("Skip"))
                ...
                out.write("<td width=40% align= center ><FONT COLOR=black FACE= Arial  SIZE=2><b><a href=file:///" + currentDir+System.getProperty("file.separator") + currentSuiteName
