...
import com.volvo.BMS.commonutilis.JExcelUtils;
...
public class TestBase extends CommonWrapperMethods  {
	...
	public void InitTestMethod(@Optional("b") String browser,@Optional("url") String appURL,Method testMethod){
		...
		else
		{
	      ...
	      test.assignAuthor("TechM Automation for BMS Application");
	      test.assignCategory("BMS_Testing");
