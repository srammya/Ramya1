...
public class GuestCheckoutWithGuestPromotionCode extends GeneralActions{
	...
	GeneralActions genAction = new GeneralActions();
	 ...
	 public void checkoutAsGuestCheckoutWithGuestPromotionCode(){
		...
		try{
					...
					int j= ReusableActions.getRandomNumber(2,5);
						...
						shoppingBucketPage.calculateAmountGuestPromo("GUEST20");
						Thread.sleep(2000);
...
//						adidasGuestCheckoutPage.clickCheckout();
	 ...
	 public void shipDetailsGuestCheckoutWithGuestPromotionCode(String sFName,String sLName,String sMail,String sPhone,String sAddress,String sCity,String sPostal,String sDay,String sMonth,String sYear){
		 shippingDetailsGuestPage=new ShippingDetailsGuestPage(driver);
			
		 try{
				ReusableActions.waitForpageToLoad(driver);
				shippingDetailsGuestPage.verifyGuestShipHeading();
				shippingDetailsGuestPage.verifyGuestOrderSummary();
	 ...
	 public void paymentDetailsGuestCheckoutWithGuestPromotionCode(String cType,String cNumber,String cExpiryMonth,String cExpiryYear,String cccvv){
