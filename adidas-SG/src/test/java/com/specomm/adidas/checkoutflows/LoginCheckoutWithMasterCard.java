...
public class LoginCheckoutWithMasterCard extends GeneralActions{
	...
	Logger log4jlogger =Logger.getLogger("devpinoyLogger");
	 ...
	 public void checkoutAsLoginCheckoutWithMasterCard(String username,String password){
	 ...
	 public void shipDetailsLoginCheckoutWithMasterCard(String sFName,String sLName,String sPhone,String sAddress,String sCity,String sPostal,String sDay,String sMonth,String sYear){
...
//				shippingDetailsLoginPage.shippingContinue();
	 ...
	 public void paymentDetailsLoginCheckoutWithMasterCard(String cType,String cNumber,String cExpiryMonth,String cExpiryYear,String cccvv){
