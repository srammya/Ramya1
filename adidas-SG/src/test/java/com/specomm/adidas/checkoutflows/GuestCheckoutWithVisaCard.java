...
import com.specomm.adidas.pagecomponents.VisaPaymentDetailsPage;
	...
	public class GuestCheckoutWithVisaCard extends GeneralActions{
		...
		GeneralActions genAction = new GeneralActions();
		 ...
		 @Test(priority = 1 ,dataProviderClass=ShippingDetailsGuestPage.class,dataProvider="getData")
		 public void shipDetailsGuestCheckoutWithVisaCard(String sFName,String sLName,String sMail,String sPhone,String sAddress,String sCity,String sPostal,String sDay,String sMonth,String sYear){
		 ...
		 @Test(priority = 2 ,dataProviderClass=VisaPaymentDetailsPage.class,dataProvider="getData")
		 public void paymentDetailsGuestCheckoutWithVisaCard(String cType,String cNumber,String cExpiryMonth,String cExpiryYear,String cccvv){
