...
public class LoginCheckoutWithMasterCardDeclined extends GeneralActions{
	...
	PaymentDeclinedPage paymentMasterDeclinedPage;
	Logger log4jlogger =Logger.getLogger("devpinoyLogger");
	 ...
	 public void checkoutAsLoginCheckoutWithMasterCardDeclined(String username,String password){
	 ...
	 public void shipDetailsLoginCheckoutWithMasterCardDeclined(String sFName,String sLName,String sPhone,String sAddress,String sCity,String sPostal,String sDay,String sMonth,String sYear){
...
//				shippingDetailsLoginPage.shippingContinue();
	 ...
	 public void paymentDetailsLoginCheckoutWithMasterCardDeclined(String cType,String cNumber,String cExpiryMonth,String cExpiryYear,String cccvv){
		 badMasterPaymentDetailsPage=new BadMasterPaymentDetailsPage(driver);
		 paymentMasterDeclinedPage=new PaymentDeclinedPage(driver);
			
		 try{
				ReusableActions.waitForpageToLoad(driver);
				badMasterPaymentDetailsPage.selectCardPaymentDetails(cType,cNumber,cExpiryMonth,cExpiryYear,cccvv);
				Thread.sleep(10000);
				paymentMasterDeclinedPage.verifyPamymentDeclinedMsg();
