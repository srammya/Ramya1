package com.specomm.adidas.shoppingbagvalidations;
...
public class ShoppingBagValidations extends GeneralActions {
static WebDriver driver;
	...
	Logger log4jlogger =Logger.getLogger("devpinoyLogger");
	 ...
	 public void ShoppingValidations(String username,String password){
			...
			productDetailsPage.selectProductToCart();
			 ...
			 System.out.println("print value for j " + j);
				for (int i = 0; i <= 2; i++) 
				{
					...
					shoppingBucketPage.updateQuantity("5");
					//shoppingBucketPage.clickUpdate("1");
					//shoppingBucketPage.verifyUpdateQuantity();
					shoppingBucketPage.verifyCalculatedItemTotal();
					shoppingBucketPage.clickEditdetails();
					Thread.sleep(2000);
					shoppingBucketPage.clickLinkRemove();
					Thread.sleep(2000);
