...
public class MasterPaymentDetailsWith3DSecurePage {
	...
	@FindBy(how = How.XPATH, using ="//*[@id='advice-validate-cc-number-cybersource_cc_number']")
	...
	public MasterPaymentDetailsWith3DSecurePage(WebDriver driver){ 
	    this.driver = driver; 
	...
	public void enterCVV(String cvv){
		try{
			...
			Assert.assertEquals(validateCC.getText(),constants.INVALID_CC_NUMBER);
	...
	public void validateCardPaymentDetails(String ccType) throws InterruptedException{
		...
		validateCCExpiryDate(ccExpiryMonth,ccExpiryYear);*/
	...
	public static Object[][] getData(){
		...
		return GeneralActions.getData("Master3DSecure");
	}
